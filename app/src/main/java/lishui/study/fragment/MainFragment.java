...
import lishui.study.activity.LeakActivity;
import lishui.study.activity.RenderActivity;
...
public class MainFragment extends Fragment {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (itemId == R.id.start_app_time_up) {
            startSimpleActivity(AppTimeUpActivity.class);
        } else if (itemId == R.id.start_render) {
            startSimpleActivity(RenderActivity.class);

        } else if (itemId == R.id.start_leak) {
            startSimpleActivity(LeakActivity.class);
        }
        return true;
    }

    private void startSimpleActivity(Class<? extends Activity> targetAty) {
        Intent intent = new Intent(requireActivity(), targetAty);
