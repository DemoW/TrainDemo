...
JNIEXPORT void JNICALL Java_lishui_demo_blur_NativeBlurProcessor_nativeBlur(
...
//    }
    ...
    stackblurJob((unsigned char *) pixelsOut, (unsigned int) w, (unsigned int) h,
