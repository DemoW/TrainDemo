package lishui.demo.blur.renderscript;
...
public class RSBlurProcessor implements BlurProcessor {
    ...
    public void blur(Bitmap original, float radius, boolean canReuseBitmap, ImageView view) {
        ...
        Utilities.THREAD_POOL_EXECUTOR.execute(()->{
            Bitmap bitmap = blurAsync(original, radius, canReuseBitmap);
    ...
    public void blur(Resources res, int id, float radius, ImageView view) {
        ...
        Utilities.THREAD_POOL_EXECUTOR.execute(()->{
            ...
            Bitmap bitmap = blurAsync(original, radius, true);
    ...
    @Override
    public Bitmap blurAsync(Bitmap original, float radius, boolean canReuse) {
    ...
    private Bitmap stack(Bitmap sentBitmap, int radius, boolean canReuseInBitmap) {
